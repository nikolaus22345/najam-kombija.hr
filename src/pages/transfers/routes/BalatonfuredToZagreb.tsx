      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-4xl font-bold text-foreground mb-4">Private Transfer from Balatonfüred to Zagreb</h1>
            <p className="text-muted-foreground mb-8">Comfortable private transfer from Balatonfüred, Hungary to Zagreb, Croatia.</p>
            ...
            <div className="prose max-w-none">
              <h2>Balatonfüred to Zagreb Transfer</h2>
              <p>Travel from the spa town of Balatonfüred on Lake Balaton to Zagreb. A comfortable cross-border journey through Hungary.</p>
            </div>
          </div>
        </div>
      </main>
...
export default BalatonfuredToZagreb;
