      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-4xl font-bold text-foreground mb-4">Private Transfer from Bovec to Zagreb</h1>
            <p className="text-muted-foreground mb-8">Comfortable private transfer from Bovec, Slovenia to Zagreb, Croatia.</p>
            ...
            <div className="prose max-w-none">
              <h2>Bovec to Zagreb Transfer</h2>
              <p>Travel from the adventure capital of Slovenia, Bovec, to Zagreb. Enjoy scenic views through the Julian Alps on your comfortable journey.</p>
            </div>
          </div>
        </div>
      </main>
