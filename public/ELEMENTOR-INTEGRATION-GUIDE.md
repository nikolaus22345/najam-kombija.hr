...
1. Napravi folder: `/wp-content/plugins/zagreb-booking-form/`
2. Kreiraj file: `zagreb-booking-form.php`
3. Dodaj header:

```php
<?php
/**
 * Plugin Name: Zagreb Transfers Booking
...
```php
$admin_email = 'info@zagreb-transfers.hr'; // Tvoj email
```
