...
2. Kreni tipkati u "PICK UP" polje (npr. "zagreb")
...
```
https://zagreb-transfers.hr/booking?pickup=Zagreb+Airport&dropoff=Split+Airport&date=2025-11-18&people=2&transfer_type=oneway
```
