...
function send_booking_email($pickup, $dropoff, $date, $people, $transfer_type) {
    $admin_email = get_option('admin_email'); // ili 'info@zagreb-transfers.hr'
    
    $subject = 'Nova Rezervacija Transfera - Zagreb Transfers';
    ...
    $headers = [
        ...
        'From: Zagreb Transfers <noreply@zagreb-transfers.hr>'
    ];
...
add_shortcode('zagreb_booking_form', 'render_booking_form_shortcode');
